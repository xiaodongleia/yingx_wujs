            ...
            $("#loginButtonId").click(function(){
                ...
                if(isOk){
                    ...
                    $.ajax({
                        ...
                        type:"post",
                        data:$("#loginForm").serialize(),//序列化获取表单的数据，根据name属性
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="enCode" id="form-code" minlength="4">
                            </div>
