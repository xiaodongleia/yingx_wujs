...
public class AliyunSendPhoneUtil {
    ...
    private static SendSmsResponse sendPhoneCode(String phoneNumbers,String signName,String templateCode,String templateParam) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4FcoTVQPRZccnTpBRqbp";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "fhvY6MyGL6RCEvLLr3USm3zPo7I6Dp";//你的accessKeySecret，参考本文档步骤2
    ...
    //发送短信
    public static String sendCode(String phoneNumbers,String code){

        String signName="逍遥镇胡辣汤";  //签名
        String templateCode="SMS_186948710";  //模板
        String templateParam="{\"code\":\""+code+"\"}"; //验证码
        SendSmsResponse sendSmsResponse = null;
        String message=null;
        try {
            //调用发送验证码的方法
            sendSmsResponse = sendPhoneCode(phoneNumbers,signName,templateCode,templateParam);
            //获取返回的信息
    ...
    public static void main(String[] args) {
        String phones="17812213148,18242093045,18336336787,15236674712";
